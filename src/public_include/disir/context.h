...
enum disir_status dc_get_value_string(dc_t *context, char *value, int64_t output_buffer_maxsize, int64_t *value_size);
...
//! supplied.
enum disir_status dc_config_begin_default_schema(const char *config_identifier, int32_t config_identifier_size, dc_t **config);
