...
//! PLUGIN API
enum disir_status
dio_toml_config_write (struct disir_instance *instance, struct disir_register_plugin *plugin,
...
// PLUGIN API
enum disir_status
dio_toml_config_query (struct disir_instance *instance, struct disir_register_plugin *plugin,
